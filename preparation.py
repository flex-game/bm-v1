...
from gdrive_utils import authenticate_gdrive, list_jpg_files_in_directory, download_file, upload_file
...
def process_frames_in_directory(frames_folder_id, analysis_folder_id, actions_folder_id, prompt_file_path):
    """Process JPEG frames in a Google Drive directory and save descriptions."""
    ...
    for i in range(len(jpg_files) - 1):
        ...
        description1 = generate_frame_description(file_name1, prompt_file_path)
        description2 = generate_frame_description(file_name2, prompt_file_path)
        ...
        action_description = generate_action_description(file_name1, file_name2, prompt_file_path)
...
if __name__ == "__main__":
    ...
    process_frames_in_directory(frames_folder_id, analysis_folder_id, actions_folder_id, prompt_file_path)